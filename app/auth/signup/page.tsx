    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="bg-gradient-to-b from-slate-800/95 via-slate-700/95 to-slate-800/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-12 border-2 border-slate-600">
          ...
          >
            Join Whiteline and start your journey to premium menswear. Create your account to save favorites, track orders, and enjoy exclusive benefits.
          </motion.p>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <Label htmlFor="confirmPassword" className="text-sm font-semibold text-white mb-2 block">
                  Confirm Password
                </Label>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-white/70" />
            ...
            >
              <div className="text-center text-sm">
                ...
                <Link href="/auth/login" className="font-medium text-white hover:text-white/80 underline transition-colors">
                  Sign in
                </Link>
              </div>
            </motion.div>
